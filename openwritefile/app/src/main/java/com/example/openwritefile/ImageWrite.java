...
import com.example.openwritefile.util.DateUtil;
import com.example.openwritefile.util.FileUtil;

public class ImageWrite extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_save) {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                Intent intent = new Intent(this, ImageRead.class);
