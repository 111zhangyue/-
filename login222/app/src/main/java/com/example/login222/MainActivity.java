...
import com.example.login222.LoginForgetActivity;
import com.example.login222.Register;
import com.example.login222.bean.UserInfo;
import com.example.login222.database.UserDBHelper;
import com.example.login222.util.DateUtil;
import com.example.login222.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"学生", "老师","18990080zy"};
