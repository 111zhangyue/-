...
public class GoodsInfo {
    ...
    private static String[] gridTitleArray = {"东野圭吾", "张皓宸", "独木舟", "威尔·杜兰特 ",
            "毛姆", "春上春树", "乔丹·彼得森", "太宰治", "吴军", "云鲸航"};
    ...
    private static int[] stagImageArray = {R.drawable.dy, R.drawable.zhc, R.drawable.dmz
            , R.drawable.we, R.drawable.mm, R.drawable.cscs, R.drawable.qdbds
            , R.drawable.tzz, R.drawable.wj, R.drawable.yjh, R.drawable.zjj
            , R.drawable.yh, R.drawable.wxb, R.drawable.mx, R.drawable.ft
            , R.drawable.xzy, R.drawable.jft, R.drawable.mmd, R.drawable.way
            , R.drawable.lxs, R.drawable.cl, R.drawable.my, R.drawable.ly};
    private static String[] stagTitleArray = {"东野圭吾", "张皓宸", "独木舟", "威尔·杜兰特", "威廉·萨默塞特·毛姆", "村上春树",
            "乔丹·彼得森", "太宰治", "吴军", "云鲸航", "张嘉佳", "余华", "王小波", "木心",
            "冯唐", "许知远", "蒋方舟", "马未都", "王安忆", "梁晓声", "池莉", "莫言", "路遥"};
